...
def main():
    ...
    pygame.display.set_caption('ARCANE PUZZLE GAME')
    ...
    while True:  # main game loop
        ...
        msg = 'Arcane Puzzle.| Click tile or press arrow keys to slide.|Press Esc To Quit.| All Fucking Rights Reserved © 2022'
        if mainBoard == SOLVEDBOARD:
            msg = 'Congrats You Freaking Solved It!'
        ...
        if slideTo:
            ...
            slideAnimation(mainBoard, slideTo, 'Arcane Puzzle.| Click tile or press arrow keys to slide.|Press Esc To Quit.| All Fucking Rights Reserved © 2022', 8)
